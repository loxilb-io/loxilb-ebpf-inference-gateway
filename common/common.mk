...
COMMON_OBJS += $(COMMON_DIR)/common_sum.o $(COMMON_DIR)/common_libbpf.o $(COMMON_DIR)/common_pdi.o $(COMMON_DIR)/common_frame.o $(COMMON_DIR)/log.o $(COMMON_DIR)/throttler.o $(COMMON_DIR)/cgroup.o $(COMMON_DIR)/sockproxy.o $(COMMON_DIR)/sockproxy_metrics.o $(COMMON_DIR)/sockproxy_routing.o $(COMMON_DIR)/sockproxy_l7policy.o $(COMMON_DIR)/sockproxy_json.o $(COMMON_DIR)/sockproxy_trace.o $(COMMON_DIR)/sockproxy_cache.o $(COMMON_DIR)/sockproxy_lb.o $(COMMON_DIR)/sockproxy_health.o $(COMMON_DIR)/sockproxy_ssl.o $(COMMON_DIR)/sockproxy_conn.o $(COMMON_DIR)/sockproxy_ep.o $(COMMON_DIR)/sockproxy_http.o $(COMMON_DIR)/sockproxy_notifier.o $(COMMON_DIR)/sockproxy_ktls.o $(COMMON_DIR)/sockproxy_h2.o $(COMMON_DIR)/sockproxy_pd.o $(COMMON_DIR)/sockproxy_pd_core.o $(COMMON_DIR)/sockproxy_pd_vllm.o $(COMMON_DIR)/sockproxy_pd_sglang.o $(COMMON_DIR)/sockproxy_pd_trie.o $(COMMON_DIR)/sockproxy_kv_exact.o $(COMMON_DIR)/sockproxy_sync.o $(COMMON_DIR)/notify.o $(COMMON_DIR)/picohttpparser.o $(COMMON_DIR)/llhttp.o $(COMMON_DIR)/httpapi.o $(COMMON_DIR)/http.o
